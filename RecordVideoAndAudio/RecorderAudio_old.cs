...
{
    public class RecorderAudio_old
    {
        ...
        {
            if (
                !File.Exists(FileName + "_in" + extention)
                ...
                && File.Exists(FileName + "_out" + extention))
            {
                ...
                {
                    var mixer = new MixingSampleProvider(new[] { reader2 });
               ...
               && !File.Exists(FileName + "_out" + extention))
            {
                ...
                {
                    var mixer = new MixingSampleProvider(new[] { reader1 });
                    WaveFileWriter.CreateWaveFile16(FileName + extention, mixer);
                }
                return;
            }
