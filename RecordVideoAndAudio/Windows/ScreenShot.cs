...
namespace Captura.Video
{
    ...
    static class ScreenShot1
    {
        ...
        public static IBitmapImage CaptureTransparent(IWindow Window, bool IncludeCursor, IPlatformServices PlatformServices)
        {
            ...
            Bitmap transparentImage = null;// GraphicsExtensions.DifferentiateAlpha(whiteShot, blackShot);
            ...
            return null;// new DrawingImage(transparentImage.CropEmptyEdges());
        }
